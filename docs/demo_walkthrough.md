...
## Run The Learned-Player Match

Promote a trained checkpoint into the demo artifact location first:
...
Then run the short engine-vs-learned-player flow:
...
If you need to restart the scene and ROS state cleanly:
...
- The Isaac GUI app opens two Franka Pandas with a procedural chessboard
...
- The learned-player demo launcher uses a promoted DQN checkpoint instead of an ad hoc training path
